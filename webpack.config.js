  ...
  const config = {
    ...
    plugins: [
      new HtmlWebpackPlugin({
        ...
        minify: !dev ? {
          ...
          removeComments: true, // Akan menghapus komentar HTML
      ...
      new CopyWebpackPlugin({
        patterns: [
          ...
          {
            from: "assets/demo/*",
            to: "assets/demo/[name][ext][query]",
          },
          {
            from: "assets/tutorial/*",
            to: "assets/tutorial/[name][ext][query]",
          },
          {
            from: "manifest*.xml",
            to: "[name]" + "[ext]",
    ...
    devServer: {
      ...
      proxy: [
        {
          context: ['/grammar-api'],
          target: 'https://svc.webspellchecker.net',
          pathRewrite: { '^/grammar-api': '/api' },
          changeOrigin: true,
          secure: false,
          headers: {
